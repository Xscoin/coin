...
static const char *strMainNetDNSSeed[][2] = {
    {"162.213.252.130", "162.213.252.130"},
    {"68.65.123.15", "68.65.123.15"},
    {NULL, NULL}
};
...
unsigned int pnSeed[] = {
    0x452363C0, /* node1.xscoin.org - 192.99.35.69 */
    0x05363B25, /* node2.xscoin.org - 37.59.54.5 */
    0x49DCE2BC, /* testnet.node1.xscoin.org - 188.226.220.73 */
};
...
void static StartSync(const vector<CNode*> &vNodes) {
    ...
    BOOST_FOREACH(CNode* pnode, vNodes) {
        ...
        if (!pnode->fClient && !pnode->fOneShot &&
            ...
            (pnode->nVersion < NOBLKS_VERSION_XSC || pnode->nVersion >= NOBLKS_VERSION_END)) {
