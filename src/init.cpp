...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/xscoin.conf are parsed in qt/bitcoin.cpp's main()
        ...
        {
            // First part of help message is specific to xscoind / RPC client
...
int main(int argc, char* argv[])
{
    ...
    // Connect xscoind signal handlers
    noui_connect();
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // requested to kill xscoin-qt during the last operation. If so, exit.
