...
#if defined(XSCOIN_NEED_QT_PLUGINS) && !defined(_XSCOIN_QT_PLUGINS_INCLUDED)
#define _XSCOIN_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        // (which not yet possible because lang=XX can be overridden in xscoin.conf in the data directory)
