...
uint256 hashGenesisBlock("0x000008321e3689b7d1d71c96d69a78a72819f3297db6b11f19fc461f20b517eb");
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    // was causing -reindex to crash xscoind
    if (hash != hashGenesisBlock) {
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        const char* pszTimestamp = "18/07/2014 - Rosetta heads for space Rubber Luck";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        // Merkle root
        assert(block.hashMerkleRoot == uint256("0x7706e97c3a41e3a5b8d1fec9839693edf21bfdec5dcc4b05f29e4cc77369198d"));
...
bool ProcessMessages(CNode* pfrom)
{
    ...
    while (!pfrom->fDisconnect && it != pfrom->vRecvMsg.end()) {
        ...
        if (memcmp(msg.hdr.pchMessageStart, pchMessageStart, sizeof(pchMessageStart)) != 0) {
            printf("\n\nPROCESSMESSAGE: INVALID MESSAGEXSC\n\n");
            fOk = false;
            break;
        }
