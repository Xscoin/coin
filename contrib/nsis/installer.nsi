...
!define HELPURL "http://xscoin.org" # "Support Information" link
!define UPDATEURL "http://xscoin.org" # "Product Updates" link
!define ABOUTURL "http://xscoin.org" # "Publisher" link
...
section "install"
	...
	createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\xscoin-qt.exe" "" "$INSTDIR\xscoin.ico"
	...
	WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\${APPNAME}" "DisplayIcon" "$\"$INSTDIR\xscoin.ico$\""
...
section "uninstall"
	...
	delete $INSTDIR\xscoind.exe
	delete $INSTDIR\xscoin-qt.exe
	delete $INSTDIR\xscoin.ico
