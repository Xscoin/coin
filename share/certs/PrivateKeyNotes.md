...
allowing somebody to distribute a StartCOIN-Qt.app or xscoin-qt-setup.exe with a valid
...
that the xscoin-qt.exe file inside the installer had not been tampered with.
